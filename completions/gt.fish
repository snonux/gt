...
complete -c gt -f -n "__fish_gt_needs_top_level" \
...
complete -c gt -f -n "__fish_gt_not_in_metric_or_custom" \
...
complete -c gt -f -n "__fish_seen_subcommand_from metric" \
...
complete -c gt -f -n "__fish_seen_subcommand_from custom" \
